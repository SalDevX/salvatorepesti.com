...
## Summary
- 64 nodes · 89 edges · 10 communities detected
...
- `Cloudflare Ecosystem` --conceptually_related_to--> `Edge Infrastructure`  [INFERRED]
  salvatorepesti.com.html → salvatorepesti.com.html  _Bridges community 2 → community 3_
...
- `salvatorepesti.com — Personal Portfolio Site` --references--> `Authentication Systems`  [EXTRACTED]
  salvatorepesti.com.html → salvatorepesti.com.html  _Bridges community 1 → community 3_
